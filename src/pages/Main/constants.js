...
export const dataCaption = [
    {
        ...
        averageInfo: (
            <p style={{ textAlign: "center" }}>
                Rata-rata jumlah kontainer dan transaksinya <br />
                dalam satu periode waktu yang dipilih.
            </p>
        ),
        averageCaption: {
            titleLeft: "Kontainer",
    ...
    },
    {
        ...
        averageInfo: (
            <p style={{ textAlign: "center" }}>
                Rata-rata jumlah transaksi ekspor dan impor <br />
                dalam satu periode waktu yang dipilih.
            </p>
        ),
        averageCaption: {
    ...
    },
    {
        ...
        averageInfo: (
            <p style={{ textAlign: "center" }}>
                Rata-rata jumlah pesanan dan transaksinya <br />
                dalam satu periode waktu yang dipilih.
            </p>
        ),
        averageCaption: {
...
export const tab = [
    ...
    {
        title: "Memproses Proforma",
        active: false,
        status: "true",
        alias: "CREATED",
        totalName: "totalCREATED",
    },
    {
...
export const proformaToolTip = {
    paid: (
        <p>
            Total transaksi proforma pengurusan baru <br />
            dan perpanjangan yang telah dibayar PPJK
        </p>
    ),
    unpaid: (
        <p>
...
export const dashboardCollapseableMenu = {
    gmv: {
        title: "GMV",
        subTitle:
    ...
    transaksi: {
        title: "Transaksi",
        subTitle:
            "Total transaksi dari seluruh metode pembayaran pada periode waktu yang dipilih.",
        total: "",
    ...
    revenue: {
        title: "Revenue",
        subTitle:
            "Total pendapatan dari seluruh transaksi pada periode waktu yang dipilih",
        containerPayLater: "",
        orderTruckPayLater: "",
...
export const akusisiToolTip = {
    aktif: {
        ...
        tooltip: (
            <p>
                Total akun PPJK yang <br />
                berhasil diaktivasi oleh BisOps.
            </p>
        ),
    },
    nonAktif: {
    ...
    trukJoin: {
        ...
        tooltip: (
            <p>
                Jumlah truk yang baru ditambahkan <br />
                mitra Trucker untuk kebutuhan PPJK
            </p>
        ),
    },
};
